      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center mb-4">
              ...
              <span className="text-xl font-bold">João Silva</span>
            </div>
            <p className="text-gray-400 mb-4">
              Engenheiro Mecânico especializado em soluções inovadoras para a indústria.
            </p>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <Button
                variant="outline"
                size="icon"
                className="w-10 h-10 bg-gray-800 hover:bg-primary border-gray-700 text-white"
                asChild
              >
              ...
              <Button
                ...
                asChild
              >
                <a href="mailto:joao.silva@engmec.com.br">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800 pt-8 mt-8 text-center">
          <p className="text-gray-400">
            © 2024 João Silva - Engenheiro Mecânico. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
